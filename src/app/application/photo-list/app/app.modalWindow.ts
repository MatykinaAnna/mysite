...
export class AppModalWindow  { 
    ...
    private httpService: HttpService|undefined = undefined;
    private httpServicePost: HttpServicePost
    public data: DataForModelWindow|null = null;
    public _idImg: number = -1;
    ...
    ngOnInit(){
        ...
        this.httpService.getData(`https://boiling-refuge-66454.herokuapp.com/images/${this._idImg}`).subscribe((data:any) => {
